...
class CategoriaResourceIT {
    ...
    public static Categoria createEntity(EntityManager em) {
        Categoria categoria = new Categoria().categoria(DEFAULT_CATEGORIA).inativo(DEFAULT_INATIVO);
        return categoria;
    }
    ...
    public static Categoria createUpdatedEntity(EntityManager em) {
        Categoria categoria = new Categoria().categoria(UPDATED_CATEGORIA).inativo(UPDATED_INATIVO);
        return categoria;
    }
    ...
    void createCategoria() throws Exception {
        ...
        assertThat(testCategoria.getInativo()).isEqualTo(DEFAULT_INATIVO);
    }
    ...
    void putNewCategoria() throws Exception {
        ...
        updatedCategoria.categoria(UPDATED_CATEGORIA).inativo(UPDATED_INATIVO);
        ...
        assertThat(testCategoria.getInativo()).isEqualTo(UPDATED_INATIVO);
    }
    ...
    void partialUpdateCategoriaWithPatch() throws Exception {
        ...
        partialUpdatedCategoria.categoria(UPDATED_CATEGORIA).inativo(UPDATED_INATIVO);
