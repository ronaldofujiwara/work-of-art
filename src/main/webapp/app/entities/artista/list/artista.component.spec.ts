...
describe('Component Tests', () => {
  describe('Artista Management Component', () => {
    let comp: ArtistaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ArtistaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.artistas?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
