...
describe('Component Tests', () => {
  describe('Tecnica Management Component', () => {
    let comp: TecnicaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TecnicaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.tecnicas?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
