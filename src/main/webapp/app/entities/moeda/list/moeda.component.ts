...
export class MoedaComponent implements OnInit {
  ...
  trackId(index: number, item: IMoeda): number {
    return item.id!;
  }

  delete(moeda: IMoeda): void {
  ...
  protected onSuccess(data: IMoeda[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
